...
WIZARD_MODEL = EnvVarSpec(
    id="WIZARD_MODEL", default="gemini-2.5-flash", is_optional=True
)
BUYER_MODEL = EnvVarSpec(
    id="BUYER_MODEL", default="google-gla:gemini-2.5-flash", is_optional=True
)
SELLER_MODEL = EnvVarSpec(
    id="SELLER_MODEL", default="google-gla:gemini-2.5-flash", is_optional=True
)
